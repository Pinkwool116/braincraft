...
这是你与代码生成器（Execution Layer）共享的工作板。用 `update_task` 工具来管理它：
- 写下当前正在解决的具体编码问题的思路
- 记录尝试过的失败方案和错误经验
- 列出代码执行所需的前置条件和步骤分解
- 代码生成器会读取这里的内容来辅助生成代码

> 注意区别：`todolist` 是你自己的规划备忘录，`update_task` 是给代码生成器看的技术草稿。
